...
__attribute__((address_space(3))) void* __acpp_sscp_get_dynamic_local_memory() {
    return __acpp_sscp_metal_symbol_local_memory("__acpp_sscp_get_dynamic_local_memory");
}

HIPSYCL_SSCP_BUILTIN
u32 __acpp_sscp_get_dynamic_local_memory_size() {
    return __acpp_sscp_metal_symbol_local_memory_size("__acpp_sscp_dynamic_local_memory_size");
}
