...
BOOST_FIXTURE_TEST_SUITE(pstl_min_element, enable_unified_shared_memory)

template<class Policy, class Generator, class Compare = std::less<>>
void test_min_element(Policy&& pol, std::size_t size, Generator&& gen,
                      Compare comp = {}) {
...
void empty_tests(Policy&& pol) {
  test_min_element(pol, 0, [](int i){return i;});
}

template<class Policy>
void single_element_tests(Policy&& pol) {
  test_min_element(pol, 1, [](int i){return i + 1;});
}

template<class Policy>
void medium_size_tests(Policy&& pol) {
  test_min_element(pol, 200, [](int i){return -i - 1;});
  test_min_element(pol, 200, [](int i){return -200 + i;});
  test_min_element(pol, 200, [](int i){return 200-i;});
  test_min_element(pol, 200, [](int i){return (i > 10 ? i : 200-i);});
  test_min_element(pol, 200, [](int i){return (i <= 10 ? i : 200-i);});
  test_min_element(pol, 200, [](int i){return i + 1;});
  test_min_element(pol, 200, [](int i){return 42;});
  test_min_element(pol, 200, [](int i){return (i < 10 ?  2 : i);});
  test_min_element(pol, 200, [](int i){return (i < 10 ?  i+3 : 2);});
  test_min_element(pol, 4, [](int i){return (i == 1 ? 100 : 42);});
  test_min_element(pol, 4, [](int i){return (i == 2 ? 100 : 42);});
}
