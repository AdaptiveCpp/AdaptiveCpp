...
HIPSYCL_SSCP_BUILTIN __acpp_f32 __acpp_sscp_unsafe_atomic_fetch_add_f32(
  ...
  return __builtin_amdgcn_global_atomic_fadd_f32( (const __attribute__((address_space(1))) float *)ptr, x);
}
...
HIPSYCL_SSCP_BUILTIN __acpp_f64 __acpp_sscp_unsafe_atomic_fetch_add_f64(
  ...
  return __builtin_amdgcn_global_atomic_fadd_f64( (const __attribute__((address_space(1))) float *)ptr, x);
}
