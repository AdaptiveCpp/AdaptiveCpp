...
* AdaptiveCpp portable CUDA: *Aksel Alpay and Vincent Heuveline. 2026. AdaptiveCpp Portable CUDA: A SYCL-Compatible CUDA Compiler for CPUs and GPUs from Multiple Vendors. In Proceedings of the International Workshop on OpenCL and SYCL (IWOCL '26). Association for Computing Machinery, New York, NY, USA, Article 1, 1–12. https://doi.org/10.1145/3811257.3811262*
