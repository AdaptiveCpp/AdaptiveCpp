...
HIPSYCL_SPECIALIZE_GET_INFO(khr::info::device, max_num_work_groups<1>)
{
...
HIPSYCL_SPECIALIZE_GET_INFO(khr::info::device, max_num_work_groups<2>)
{
  std::size_t size0 = static_cast<std::size_t>(get_rt_device()->get_property(
      rt::device_uint_property::max_num_work_groups0));
...
HIPSYCL_SPECIALIZE_GET_INFO(khr::info::device, max_num_work_groups<3>)
{
  std::size_t size0 = static_cast<std::size_t>(get_rt_device()->get_property(
      rt::device_uint_property::max_num_work_groups0));
  std::size_t size1 = static_cast<std::size_t>(get_rt_device()->get_property(
